...
{
    public class AtualizarCadastroLojaPessoaFisicaRequest
    {
        ...
        public string naturalized { get; set; }
        ...
        public string monthly_gross_income { get { return monthlyGrossIncome; } set { monthlyGrossIncome = value; } }
        public string grossEquity { get; set; }

        public string gross_equity { get { return grossEquity; } set { grossEquity = value; } }
